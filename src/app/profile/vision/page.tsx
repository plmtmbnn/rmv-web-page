				...
				<section className="grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
					<div className="md:col-span-7 lg:col-span-8">
						...
						<p className="mt-4 text-gray-700 leading-relaxed text-justify">
							...
							(startup) dan/atau berada dalam tahap pengembangan usaha.
						</p>
						...
						<ul className="mt-4 space-y-3 text-gray-700 leading-relaxed list-disc pl-6 text-justify">
							<li>
								...
								konversi dalam jangka waktu tertentu dalam rangka pengembangan
								usaha pada Pasangan Usaha dengan tetap prinsip tata kelola
								perusahaan yang baik dan asas kehati-hatian.
							</li>
							<li>
								Memberikan akses permodalan bagi para usaha rintisan (startup),
								pengembangan perusahaan atau yang mengalami kesulitan dana.
							</li>
							<li>
								Membantu dan/atau mengambil alih Perusahaan yang berada pada
								tahap pengembangan atau tahap kemunduran usaha.
							</li>
							<li>
								Menciptakan sinergi dan memberikan nilai tambah melalui berbagai
								saluran pembiayaan kepentingan.
							</li>
							<li>
								Menghadirkan layanan yang berkualitas dan inovatif sehingga
								tercipta kepercayaan yang tinggi secara berkelanjutan.
							</li>
						</ul>
					</div>
