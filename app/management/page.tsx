        ...
        <div className="container mx-auto px-4 md:px-8 lg:px-12">
          ...
          <div className="mb-12 text-center lg:text-left">
            ...
            <p className="text-lg text-slate-600 max-w-2xl">
              Dipimpin oleh para profesional berpengalaman yang berkomitmen dalam mengembangkan ekosistem bisnis Indonesia.
            </p>
          </div>
            ...
            {members.map((member, index) => (
              ...
              >
                ...
                <div className="relative z-10 px-6 pt-6 pb-6 text-white">
                  ...
                  {/* Action Button */}
                  <div className="mt-4 flex items-center justify-between pt-4 border-t border-white/20" hidden={!member?.detail}>
                    <span className="text-xs text-blue-100">Lihat profil lengkap</span>
      ...
      {selected && (
        ...
        >
          ...
          >
            ...
            {/* Modal Body */}
            <div className="px-6 md:px-8 py-8 overflow-y-auto" style={{ maxHeight: 'calc(95vh - 300px)' }}>
