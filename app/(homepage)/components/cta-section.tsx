			...
			<div className="relative">
				...
				<div className="relative rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-500">
					<div className="relative w-full min-h-[320px] md:min-h-[280px] lg:min-h-[320px]">
						...
						<div
							aria-hidden
							className="absolute inset-0 bg-gradient-to-br from-[#051b5a]/95 via-[#051b5a]/85 to-blue-900/90"
						></div>
									...
									<div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
										...
										<div className="lg:col-span-7 text-center lg:text-left">
											...
											<p className="text-sm md:text-base text-blue-100/90 leading-relaxed mb-6 max-w-xl mx-auto lg:mx-0">
												Kami membuka peluang bagi para founder berwawasan jauh
												ke depan untuk menghadirkan inovasi yang mengubah
												industri. Kirimkan proposal Anda dan mari wujudkan masa
												depan yang lebih progresif bersama.
											</p>
