...
const financialReports: YearReport[] = [
  {
    year: 2024,
    files: [
      { name: "Lampiran 1.c. Tahun Buku 2024", url: "/investor/financial_reports/2023/Lampiran 1.b. Tahun Buku 2023.pdf", type: "pdf" }
    ],
  },
  {
    year: 2023,
    files: [
      { name: "Lampiran 1.b. Tahun buku 2023", url: "/investor/financial_reports/2023/Lampiran 1.b. Tahun Buku 2023.pdf", type: "pdf" }
    ],
  },
];
      ...
      {data.map((yearGroup) => (
        <div key={yearGroup.year} className="relative">
          ...
          <div className="flex items-center gap-4 mb-6">
            <h2 className="text-3xl font-bold text-slate-200">{yearGroup.year}</h2>
                ...
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3 text-xs text-slate-500 mt-1">
                        <span className="uppercase font-medium tracking-wide">{file.type}</span>
                        {file.size && (
                            <>
...
export default function InvestorPage() {
  const [activeTab, setActiveTab] = useState<"financial" | "sustainability">("financial");
      ...
      <div className="container relative mx-auto px-6 md:px-12 lg:px-20 py-16 md:py-24">
        ...
        <div className="mb-12 max-w-3xl">
          ...
          <p className="text-slate-600 text-lg leading-relaxed">
            Akses dokumen keuangan dan laporan keberlanjutan kami sebagai wujud transparansi 
            dan akuntabilitas perusahaan kepada para pemangku kepentingan.
          </p>
        </div>
        ...
        <div className="mt-20 p-6 bg-white rounded-2xl border border-slate-100 shadow-sm flex flex-col md:flex-row items-start md:items-center gap-6">
            ...
            <div className="flex-1">
                <h4 className="text-base font-bold text-slate-900 mb-1">Butuh informasi lebih detail?</h4>
                <p className="text-sm text-slate-600">
                    Jika Anda membutuhkan laporan periode sebelumnya atau dokumen spesifik yang tidak tercantum, 
                    silakan hubungi tim Corporate Secretary kami.
                </p>
            </div>
            <a 
